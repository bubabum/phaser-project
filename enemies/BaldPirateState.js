class BaldPirateIdle extends State {
	constructor(enemy) {
...
class BaldPirateRun extends State {
	constructor(enemy) {
...
class BaldPirateMoveToPlayer extends State {
	constructor(enemy) {
...
class BaldPirateClimbUp extends State {
	constructor(enemy) {
...
class BaldPirateJumpUp extends State {
	constructor(enemy) {
...
class BaldPirateLongJumpUp extends State {
	constructor(enemy) {
...
class BaldPirateJumpDown extends State {
	constructor(enemy) {
...
class BaldPirateLongJumpDown extends State {
	constructor(enemy) {
